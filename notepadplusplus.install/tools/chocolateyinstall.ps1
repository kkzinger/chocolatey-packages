...
$packageName= 'notepadplusplus.install' # arbitrary name for the package, used in messages
$toolsDir   = "$(Split-Path -parent $MyInvocation.MyCommand.Definition)"
$url        = 'https://notepad-plus-plus.org/repository/6.x/6.9.1/npp.6.9.1.Installer.exe' # download url
$url64      = 'https://notepad-plus-plus.org/repository/6.x/6.9.1/npp.6.9.1.Installer.exe' # 64bit URL here or remove - if installer is both, use $url
...
$packageArgs = @{
  ...
  softwareName  = 'notepadplusplus.install*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
  checksum      = '28d8a6ad14574f65c6e8e2005107a828f8c0e77b'
  checksumType  = 'sha1' #default is md5, can also be sha1
  checksum64    = '28d8a6ad14574f65c6e8e2005107a828f8c0e77b'
